# Databricks notebook source exported at Mon, 10 Oct 2016 09:22:24 UTC
# MAGIC %md
...
movies_with_500_ratings_or_more = movie_names_with_avg_ratings_df.filter("count >= 500").orderBy(movie_names_with_avg_ratings_df.average.desc())
...
predicted_highest_rated_movies_df = predicted_with_counts_df.orderBy(F.desc("prediction")).filter(predicted_with_counts_df['count'] > 75)
