# Databricks notebook source exported at Mon, 10 Oct 2016 09:23:04 UTC
# MAGIC %md
...
def tf(tokens):
    ...
    """
    tokenCounts = {}
    for t in tokens: tokenCounts[t] = tokenCounts.get(t, 0) + (1.0/len(tokens))
    return tokenCounts
